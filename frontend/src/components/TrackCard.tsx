      ...
      <div className="relative">
        {imageError ? (
          <div className="w-full h-48 bg-gray-700 rounded-md mb-4 flex items-center justify-center">
            <span className="material-icons text-gray-500 text-4xl">music_note</span>
          </div>
        ) : (
          <img 
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-md mb-4"></div>
        
        {/* Play Button */}
        <div className="absolute bottom-6 right-4">
          <button 
            onClick={handlePlay}
            className="play-button bg-green-500 text-black rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 w-12 h-12 flex items-center justify-center hover:bg-green-400 hover:scale-105"
          >
        ...
        <div className="absolute top-4 right-4">
          <button 
            onClick={handleLike}
            className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-white hover:text-green-500"
          >
